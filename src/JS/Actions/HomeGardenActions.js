...
export const getHomeGardens = () => async (dispatch) => {console.log("hello");
  ...
  console.log("hello");
  try {
    const result = await axios.get(`${process.env.REACT_APP_API_URL}/api/HomeGarden/getHomeGardens`);
...
export const getHomeGardensByCategory = (category) => async (dispatch) => {
  ...
  try {
    const result = await axios.get(
      `${process.env.REACT_APP_API_URL}/api/HomeGarden/getHomeGardenByCategory/${category}`
    );
...
export const addHomeGarden = (newHG) => async (dispatch) => {
  ...
  try {
    const result = await axios.post(`${process.env.REACT_APP_API_URL}/api/HomeGarden/addHomeGarden`, newHG);
  ...
  export const getHomeGardenById = (id) => async (dispatch) => {
    ...
    try {
      const result = await axios.get(
        `${process.env.REACT_APP_API_URL}/api/HomeGarden/getHomeGardenById/${id}`
      );
      ...
      async (dispatch) => {
        ...
        try {
          const result = await axios.delete(
            `${process.env.REACT_APP_API_URL}/api/HomeGarden/deleteHomeGarden/${id}`
          );
          dispatch({
         ...
         async (dispatch) => {
           ...
           try {
             const result = await axios.put(
               `${process.env.REACT_APP_API_URL}/api/HomeGarden/editHomeGarden/${id}`,
               newCar
             );
